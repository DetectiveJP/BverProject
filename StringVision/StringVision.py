...
def main():
    ...
    for filename in list_image:
        ...
        if os.path.exists(protocol_save_path):
            ...
            f.write("\n")
            f.write('Calibration' + "\n")
            f.write("Total calibration error: {} " .format(error) + "\n")
            f.write("Camera Matrix: {} ".format(mtx[0]) + "\n")
            f.write("               {} ".format(mtx[1]) + "\n")
            f.write("               {} ".format(mtx[2]) + "\n")
            f.write("Distortion coefficients {}".format(dist) + "\n")
            f.write("\n")
